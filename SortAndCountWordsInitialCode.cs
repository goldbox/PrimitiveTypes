...
{
    public struct TimDictionary
    {
        public string word;
        public int occurency;

        public TimDictionary ( string word, int occurency)
        {
            this.word = word;
    ...
    public class SortAndCountWordsInitialCode
    {
        ...
        public void SimpleTest()
        {
            ...
            TimDictionary[] animalsActual = CountAndSortWords(inputString);
        ...
        private TimDictionary[] CountAndSortWords(string inputString)
        {
            ...
            foreach(string word in arrayInputString)
            {
                ...
                else
                {
                    ...
                    dictionary[index].occurency = 1;
                }
            }
            dictionary = SortByOccurency (dictionary);
            return dictionary;
        }
